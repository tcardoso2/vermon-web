/**
 * Test file for Job: iobrokerlog
 */

var assert = require ('assert');
var iobrokerlog_SUT = require('../iobrokerlog');

var mockedConfig, mockedDependencies;

describe ('iobrokerlog test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      iobrokerlog_SUT.onRun(config, mockedDependencies, function(err, data){
