/**
 * Test file for Job: detectors
 */

var assert = require ('assert');
var detectors_SUT = require('../detectors');

var mockedConfig, mockedDependencies;

describe ('detectors test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      detectors_SUT.onRun(config, mockedDependencies, function(err, data){
