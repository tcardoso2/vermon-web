...
//This file will be deprecated! It's the old main.js file will be replaced by a new one
...
var log = vermon.SetTraceLevel('warn');
...
if(!pm.AddPlugin(module)) throw new Error('There was an error adding this plug-in');
if (vermon.Cli.startweb) {
  log.info('  Starting web server;');
  if (vermon.Cli.defaultConfig) {
